---
<span style="float: left; display: contents;"><i class="icon-download-alt icon-1x"></i> 源文件下载 / [Ver. 2022-07-13](https://cdn.ericp.cn/s/mathjax_tutorial_mdeditor_220713.md) / [Ver. 2020-10-03](https://cdn.ericp.cn/s/mathjax_tutorial_mdeditor_201003.md)</span><span style="float: right; display: block;">本文固定链接 https://ericp.cn/cmd</span>

# Cmd Markdown 公式指导手册

<p style="margin-top: 100px"> </p>

> 由于 Cmd Markdown 编辑器及本手册均已放弃维护，最后嵌入版本为 MathJax.js v2.2，可能与当前现代浏览器产生部分不兼容或渲染出错，您可在相关位置批注，我会收到邮件通知并确认更正。

> 建议您在 Chrome 或 Edge 浏览器中使用 Cmd Markdown 编辑器。

<span style="float: right; display: block;"><i class="icon-edit icon-1x"></i> Ver. 2022-07-13</span>

...
1. 空间向量：
   与[[数学·必修第二册#必修二·第六章·平面向量及其应用|平面向量]]一样，在空间，我们把具有大小和方向的量叫做空间向量(spacevector)，空间向量的大小叫做空间向量的长度或模(modulus). 空间向量用字母$\vec{a},\vec{b}.\vec{c}...$ 表示。

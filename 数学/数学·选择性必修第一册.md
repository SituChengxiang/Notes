...
- $tan\theta,\theta \in [0，\pi)$ ，沿逆时针方向旋转越来越大，**但是与 y 重合的时候是没有定义的！**
...
显然圆心$(-\dfrac{D}{2},-\dfrac{E}{2})$ ,半径 $r=\dfrac{D^2+E^2-4F}{4}$
...
两圆半径为 $r_1,r_2 ,d=\lvert O_1O_2 \rvert$
 ...
 [![圆于圆的位置关系.png](https://pic.img.ski/1661731426.png) ](https://pic.img.ski/1661731426.png)

...
> 离心率表示椭圆的扁平程度，用 $e$ 表示 衡量焦点片离原点的程度
$$
...
2. 离心率的求解
   1. 焦点三角形中离心率的求法：  
      ...
      $$
      \boxed{e=\dfrac{c}{a}=\dfrac{sin(\alpha+\beta)}{sin \alpha+sin\beta}}
      $$

   2. 齐次化离心率求解（多用几何关系）
   3. 焦点三角形面积秒杀公式
      $$
         S_{\triangle PF_1F_2}=b^2tan(\dfrac{\theta}{2}) \\
         \begin{cases}
         |PF_1|+|PF_2|=2a \\
         |F_1F_2|=2c \
         \end{cases} \\
      ...
      4c^2=4a^2-2|PF_1||PF_2|-2|PF_1||PF_2|(1+cos\theta)\\
      \boxed{S=b^2tan(\dfrac{\theta}{2})}
      $$ 
